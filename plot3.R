...
##     the complete database and plots the energy sub-metering corresponding to
##     kitchen, laundry room, and water heater/AC vs the timestamp with
...
################################################################################
##
## Open a png graphics device, create "plot3.png" with a width and height of
## 480 pixels each
##
################################################################################
