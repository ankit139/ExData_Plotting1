...
##     the complete database and creates a histogram of the household global
...
################################################################################
##
## Open a png graphics device, create "plot1.png" with a width and height of
## 480 pixels each
##
################################################################################
...
################################################################################
##
## Create a histogram of the household global minute-averaged active power (in
## kilowatt) represented by the column 'Global_active_power'.
##
################################################################################
